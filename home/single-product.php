                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 col-lg-6 text-lg-start text-center">
                        <div class="header-top-msg-wrapper">
                            <p class="header-top-message">欢迎：XXX 来到商城</p>
                        </div>
                    </div>
                    ...
                    <div class="product-details-img">
                        ...
                        <div class="single-product-img swiper-container product-gallery-top">
                            <div class="swiper-wrapper popup-gallery">
                                <a class="swiper-slide w-100" href="assets/images/products/large-product/1.jpg">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title">商品名字</h2>
                        </div>
                        <!-- Product Head End -->
                        ...
                        <!-- SKU Start    -->
                        <div class="sku mb-3">
                            <span>商品标签: 12345</span>
                        </div>
                        <!-- SKU End -->

                        <!-- Product Inventory Start -->
                        <div class="product-inventroy mb-3">
                            <span class="inventroy-title"> <strong>剩余量:</strong></span>
                            <span class="inventory-varient">12 </span>
                        </div>
                        <!-- Product Inventory End -->

                        <!-- Description Start   产品介绍 -->
                        <p class="desc-content mb-5">这是我的产品介绍 I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p>
                        <!-- Description End -->
                        ...
                        <div class="product-size mb-5">
                            ...
                            <a href="#" class="size-ratio active"></a>
                            <a href="#" class="size-ratio"></a>
                            <a href="#" class="size-ratio"></a>
                            <a href="#" class="size-ratio"></a>
                        </div>
                        <!-- Product Size End -->
                        ...
                        <div class="actions border-bottom mb-4 pb-4">
                            ...
                            <a href="wishlist.html" title="Wishlist" class="action wishlist"><i class="pe-7s-like"></i> 是否收藏</a>
                        </div>
                        <!-- Action Button End -->

                        <!-- Social Shear Start -->
                        <div class="social-share">
                            <span><strong>其他支付: </strong></span>
                        ...
                        <ul class="product-delivery-policy border-top pt-4 mt-4 border-bottom pb-4">
                            <li> <i class="fa fa-check-square"></i> <span>安全策略</span></li>
                            <li><i class="fa fa-truck"></i><span>交付政策</span></li>
                            <li><i class="fa fa-refresh"></i><span>退货政策</span></li>
                        </ul>
            ...
            <div class="row section-margin">
                ...
                <div class="col-lg-12 single-product-tab">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#connect-1" role="tab" aria-selected="true">商品描述</a>
                        </li>
                        <li class="nav-item">
