<?php
include "../controller/waresAll.php";
$homeConfig=array();
$homeConfig["imgPath"]="../IMG/";

$salesGoods=homepageWares("sp_sold","5");//销量最高  火爆产品
$salesGoods=json_decode($salesGoods,true);
$salesGoods=$salesGoods["data"];
$salesGoods=$salesGoods["wareslist"];

$hotGoods=homepageWares("sp_hot",6);  //热度排序  推荐
$hotGoods=json_decode($hotGoods,true);
$hotGoods=$hotGoods["data"];
$hotGoods=$hotGoods["wareslist"];

$newestGoods=homepageWares("create_time",6);//最新上架
$newestGoods=json_decode($newestGoods,true);
$newestGoods=$newestGoods["data"];
$newestGoods=$newestGoods["wareslist"];
...
//                                    echo $row["sp_uid"].$row["sp_name"].$row["sp_price"]."<br/>";
                                ...
                                <div class="swiper-slide">
                                    <div class="product-wrapper">
                                        <div class="product mb-6">
                                            ...
                                            <div class="content">
                                                <h5 class="title"><a href="single-product.html"><?php echo $row["sp_name"] ?></a></h5>
                                                <span class="price">
                                                    <span class="new">
                                            ...
                                            <div class="single-product-list mb-4">
                                                ...
                                                <div class="product-list-content">
                                                    <h6 class="product-name">
                                                        <a href="single-product.html"><?php echo $row["sp_name"] ?></a>
                                                    </h6>
