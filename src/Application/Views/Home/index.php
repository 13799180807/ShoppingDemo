                ...
                <div class="col-12">
                    <div class="header-top-msg-wrapper text-center">
                        <p class="header-top-message text-center">
                            产品上新啦 <strong>快去选购</strong><a href="shop.php"
                                                          class="btn btn-hover-dark btn-secondary">去购物吧</a></p>
                ...
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-2 col-6">
                        <div class="header-logo">
                            <a href="index.php"><img src="<?php echo ASSETS; ?>images/logo/logo.png"
                                                     alt="Site Logo"/></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
...
<div class="section section-margin mt-0 position-relative">
                                            ...
                                            <div class="product mb-6">
                                                <div class="thumb">
                                                    ...
                                                    <div class="actions">
                                                        ...
                                                        <a class="action quickview" data-bs-toggle="modal"
                                                           data-bs-target="#quick-view"><i class="pe-7s-search"></i></a>
                                                    </div>
                                                    <!--添加到购物车-->
                                                    <div class="add-cart-btn">
                                                        <button class="btn btn-whited btn-hover-primary text-capitalize add-to-cart">
                                                            添加到购物车
                                                        </button>
                                                    </div>
                                                    <!--添加到购物车结束-->
    ...
    <div class="add-cart-btn" style="margin-left: 45%">
        <a href="shop.php">
            <button class="btn btn-whited btn-hover-primary text-capitalize add-to-cart">查看更多分类</button>
        </a>
    </div>
</div>
<!-- Product Section End -->
                                            ...
                                            <div class="single-product-list mb-4">
                                                <div class="product">
                                                    <div class="thumb">
                                                        <a href="single-product.php?commodity=<?php echo $row["goodsId"]; ?>"
                                                           class="image">
                                                            <img class="fit-image first-image" src="<?php echo $img; ?>"
                                                                 alt="Product Image">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-list-content">
                                                    ...
                                                    <span class="ratings justify-content-start mb-3">
														<span class="rating-wrap">
															<span class="star"
                                                                  style="width: <?php echo $xing; ?>%"></span>
                                                </span>
