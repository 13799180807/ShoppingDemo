...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $publicPath;?>images/favicon.ico">
    <link rel="stylesheet" href="<?php echo $publicPath;?>css/vendor/vendor.min.css">
    <link rel="stylesheet" href="<?php echo $publicPath;?>css/plugins/plugins.min.css">
    <link rel="stylesheet" href="<?php echo $publicPath;?>css/style.min.css">
                ...
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-2 col-6">
                        <div class="header-logo">
                            <a href="index.view.php"><img src="<?php echo $publicPath;?>images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        ...
                        <div class="main-menu">
                            <ul>
                                <li><a href="index.view.php">首页</a></li>
                                <li><a href="#">更多商品</a></li>
                                <li><a href="#">关于</a></li>
                                <li><a href="#">联系</a></li>
                            </ul>
        ...
        <div class="cart-offcanvas-inner">
            ...
            <div class="offcanvas-cart-content">
                ...
                <div class="cart-product-wrapper mb-4 pb-4 border-bottom">
                    ...
                    <div class="single-cart-product">
                        <div class="cart-product-thumb">
                            <a href="single-product.html"><img src="<?php echo $publicPath;?>images/products/small-product/1.jpg" alt="Cart Product"></a>
                        </div>
                ...
                <div class="cart-product-wrapper mb-4 pb-4 border-bottom">
                    ...
                    <div class="single-cart-product">
                        <div class="cart-product-thumb">
                            <a href="single-product.html"><img src="<?php echo $publicPath;?>images/products/small-product/2.jpg" alt="Cart Product"></a>
                        </div>
                        <div class="cart-product-content">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="hero-slide-item swiper-slide">
                <div class="hero-slide-bg">
                    <img src="<?php echo $publicPath;?>images/slider/slider1-1.png" alt="Slider Image" />
                </div>
                <div class="container">
            ...
            <div class="hero-slide-item swiper-slide">
                <div class="hero-slide-bg">
                    <img src="a<?php echo $publicPath;?>images/slider/slider1-2.png" alt="Slider Image" />
                </div>
                <div class="container">
                    <div class="hero-slide-content">
...
<script src="<?php echo $publicPath;?>js/vendor.min.js"></script>
<script src="<?php echo $publicPath;?>js/plugins.min.js"></script>
